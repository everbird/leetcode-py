...
def sub(bills, b5=0, b10=0, b20=0):
    if not bills:
        return True
    ...
    b = bills[0]
    if b == 5:
        return sub(bills[1:], b5+1, b10, b20)

    if b == 10:
        if b5 <= 0:
            return False
        return sub(bills[1:], b5-1, b10+1, b20)

    if b5 <= 0:
        return False
    elif 1 <= b5 <= 2 and b10 <= 0:
        return False

    return sub(bills[1:], b5-1, b10-1, b20+1) or sub(bills[1:], b5-3, b10, b20+1)
